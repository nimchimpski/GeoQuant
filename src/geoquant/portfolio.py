...
def base_ccy_assets_px_df(holdings, fx_map, data_params, ohlc=False):
    ...
    if not ohlc:
        ...
        prices_df = series_utils.trim_series(prices_df, from_dt, to_dt)
        return prices_df
    ...
    high_df = series_utils.trim_series(high_df, from_dt, to_dt)
    low_df = series_utils.trim_series(low_df, from_dt, to_dt)
    close_df = series_utils.trim_series(close_df, from_dt, to_dt)
